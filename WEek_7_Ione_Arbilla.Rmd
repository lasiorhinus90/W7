...
Reading csv file in RDataset obtained from Jobs dataset in https://data.worldbank.org/ and not importing lines located at the end of the document with the filter function.
